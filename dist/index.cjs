  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "button",
    {
      ...
      children: loading ? /* @__PURE__ */ jsxRuntime.jsxs("span", { className: "flex items-center justify-center gap-2", children: [
        ...
        leftIcon ? /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", children: leftIcon }) : null,
        children,
        rightIcon ? /* @__PURE__ */ jsxRuntime.jsx("span", { "aria-hidden": "true", children: rightIcon }) : null
      ] })
    }
  );
});
...
function ConfirmDialog({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    Modal,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("h2", { id: titleId, className: "text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4", children: title }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-white/70 mb-4 sm:mb-6", children: message }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col-reverse sm:flex-row gap-3 sm:justify-end", children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            Button,
            {
              type: "button",
...
function EmptyState({ icon: Icon, title, description, actionLabel, onAction, children, className }) {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cn("flex flex-col items-center justify-center py-12 px-4 text-center", className), children: [
    Icon ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: "mb-4 rounded-full bg-white/10 p-4", children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { className: "h-8 w-8 text-white/50" }) }) : null,
    /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "text-lg font-semibold text-white mb-2", children: title }),
    description ? /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-white/60 max-w-md mb-6", children: description }) : null,
    actionLabel && onAction ? /* @__PURE__ */ jsxRuntime.jsx(Button, { type: "button", variant: "primary", onClick: onAction, children: actionLabel }) : null,
    children
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cn("rounded-xl ring-1 ring-white/10 bg-white/5 overflow-hidden", className), children: [
      ...
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-sm font-semibold text-white", children: title })
          ] }),
          right
        ]
      }
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "overflow-hidden", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "px-4 pb-3", children }) })
      }
    )
  ] });
}
